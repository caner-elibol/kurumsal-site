            ...
            <div class="row justify-content-between">
                ...
                <!-- <div class="col-lg-3 col-md-6">
                    <div class="feature-box flex-column text-center">
                        ...
                        <div class="fbox-content">
                            <h3 class="nott ls0 mb-4">Appeal:</h3>
                            <p class="text-smaller mb-3">
                                It is possible to apply instantly! If you wish, you can apply immediately by clicking on the field below.</p>
                            <a href="/joinus"><u>Click Here</u></a>
                        </div>
                    </div>
                </div> -->
            </div>
