<section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header" style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #39384D), url('/demos/seo/images/about-title.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
    <div id="particles-line"></div>

    <div class="container clearfix mt-4">
        <div class="badge rounded-pill border border-light text-light">Hakkımızda</div>
        <h1>BİZ KİMİZ?</h1>
        <ol class="breadcrumb">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="heading-block border-bottom-0 mb-0">
                            <div class="badge rounded-pill badge-default">Büyüme</div>
                            <h3 class="nott ls0 mb-3">Zaman Geçtikçe Güçlenme ve Büyüme Gösteriyoruz</h3>
                            <p>Küçük, Orta ve Büyük Ölçekli İşletmelere sağladığımız ödeme sistemleri danışmanlık ve uygulamalarımızın etkisi ile kısa zamanda tüm misyonlarımız ve vizyonlarımızı gerçekleştirmeye devam ediyoruz. </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <p class="text-end text-muted text-smaller">Açılışımızdan Bugüne: <span class="text-success fw-bold text-larger">+770%</span></p>
        ...
        <div class="section bg-transparent m-0 pt-3 pb-0">
            <div class="container mw-md">
                ...
                <div class="text-md-center">
                    <h3 class="bg-color d-inline-block px-4 py-2 text-white mb-0 rounded-1">Kronolojik bakış</h3>
                </div>
                <div class="story-timeline">
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 text-md-end">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Ara, 2021</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5">
                            <h3 class="mb-3">Başlangıç Noktası</h3>
                            14 Aralık 2021 tarihinde kurulduk.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 order-md-2">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Haz, 2022</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5 text-md-end">
                            <h3 class="mb-3">Ödeme Almaya Başladık</h3>
                            Haziran ayında, kuruluşumuzdan tam 6 ay sonra gerekli tüm entegrasyonlarımızı tamamlayarak iş ortaklarımız aracılığı ile ödeme almaya başladık.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 text-md-end">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Ekim, 2022</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5">
                            <h3 class="mb-3"><span class="counter counter-inherit text-dark">+<span data-from="11" data-to="121" data-refresh-interval="10" data-speed="1000"></span>% Ödeme Yapılan İşlem </span></h3>
                            Ekim ayına geldğimizde, Haziran ayında başladığımız ödeme işlemlerinde %121 seviyelerinde artış sağladık.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 order-md-2">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Ocak, 2023</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5 text-md-end">
                            <h3 class="mb-3"><span class="counter counter-inherit text-dark"><span data-from="1" data-to="20" data-refresh-interval="10" data-speed="1500"></span>+ Çalışan Sayısına Ulaştık</span></h3>
                            Ayrı konularda tam ve yeterlilik seviyesinin üstünde bilgili kadromuz genişlemeye devam ediyor ve hizmetlerimiz her geçen gün kalitesine kalite ekliyor.
                        </div>
                    </div>
                    <div class="clear my-5"></div>
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 text-md-end">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Eylül, 2023</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5">
                            ...
                            <div class="card-body p-5">
                                <div class="feature-box flex-column">
                                    ...
                                    <div class="fbox-content">
                                        <h3 class="nott ls0 text-larger">Akıllı Teknoloji</h3>
                                        <p class="text-smaller">Tüm ödeme </p>
                                    </div>
