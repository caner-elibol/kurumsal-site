                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="heading-block border-bottom-0 mb-0">
                            <div class="badge rounded-pill badge-default">Growth</div>
                            <h3 class="nott ls0 mb-3">We Show Strength and Growth Over Time</h3>
                            <p>We continue to realize all our missions and visions in a short time with the effect of our payment systems consultancy and applications we provide to Small, Medium and Large-Scale Enterprises. </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <p class="text-end text-muted text-smaller">Since Our Opening: <span class="text-success fw-bold text-larger">+770%</span></p>
        ...
        <div class="section bg-transparent m-0 pt-3 pb-0">
            <div class="container mw-md">
                ...
                <div class="text-md-center">
                    <h3 class="bg-color d-inline-block px-4 py-2 text-white mb-0 rounded-1">Chronological Overview</h3>
                </div>
                <div class="story-timeline">
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 text-md-end">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Dec, 2021</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5">
                            <h3 class="mb-3">Starting point</h3>
                            We were established on December 14, 2021.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 order-md-2">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Jun, 2022</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5 text-md-end">
                            <h3 class="mb-3">We Started Receiving Payments</h3>
                            In June, 6 months after our establishment, we completed all necessary integrations and started receiving payments through our business partners.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 text-md-end">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Oct, 2022</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5">
                            <h3 class="mb-3"><span class="counter counter-inherit text-dark">+<span data-from="11" data-to="121" data-refresh-interval="10" data-speed="1000"></span>% Payment Transaction </span></h3>
                            When we come to October, we achieved an increase of 121% in the payment transactions that we started in June.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 order-md-2">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Jan, 2023</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5 text-md-end">
                            <h3 class="mb-3"><span class="counter counter-inherit text-dark"><span data-from="1" data-to="20" data-refresh-interval="10" data-speed="1500"></span>+ Reached Number of Employees</span></h3>
                            Our staff, which is fully and above the level of competence in separate subjects, continues to expand and our services add quality to its quality day by day.
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-5 text-md-end">
                            <h4 class="bg-secondary d-inline-block px-3 py-1 text-white mb-0 rounded-1 mb-3">Sep, 2023</h4>
                        </div>
                        <div class="story-timeline-dots"></div>
                        <div class="col-md-5">
