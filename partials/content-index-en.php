        ...
        <div class="section bg-transparent mt-4 mb-0 pb-0">
            <div class="container">
                <div class="heading-block border-bottom-0 center mx-auto mb-0" style="max-width: 550px">
                    ...
                    <p>JunoMoney is ushering in a new era in payment solutions. Our platform, equipped with advanced technology, provides businesses and consumers with convenience by offering all bank transfers, credit card, and digital wallet options in a single integration. Customers can securely complete their purchases using various payment methods, while businesses can simplify complex payment processes and enhance efficiency. JunoMoney is redefining the payment experience with its user-friendly interface and secure infrastructure, leading the way into the future of payments.</p>
                </div>
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="/features/featuredetail/pos"><img src="/demos/seo/images/icons/optimizing.svg" alt="Sanal Pos" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott ls0">Virtual Pos</h3>
                                <p>POS software based payment solution that enables the merchants to accept payments from their customers arising from purchases made over the Internet via credit or debit cards.</p>
                            </div>
                        </div>

                        <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="/features/featuredetail/transfer"><img src="/demos/seo/images/icons/transfer.svg" alt="Para Transferi" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott ls0">Money Transfer</h3>
                                <p>Allows you to receive remittance payments with contracted banks.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-box border-0">
                            <div class="fbox-icon">
                                <a href="#"><img src="/demos/seo/images/icons/man.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                                <h3 class="nott ls0">7/24 Support</h3>
                                <p>With our knowledgeable staff, all your questions and problems are supported in the fastest way.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-box border-0 mt-5">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott ls0">Customer Services</h3>
                                <p>We meet all your needs within the scope of customer service.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-box border-0 mt-5">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott ls0">It's Very Simple</h3>
                                <p>You can start receiving payments in a short time by contacting us quickly through the site or our contact number.</p>
                            </div>
                        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-4 mt-4">
                        <div class="heading-block border-bottom-0 bottommargin-sm">
                            <div class="badge rounded-pill badge-default">Sharing Rates</div>
                            <h3 class="nott ls0">We Offer You The <br> Best Rates </h3>
                        </div>
                        <p>Get the best service with the best rates. Please select your product type.</p>
                        <div class="pricing-tenure-switcher d-flex align-items-center mb-4 position-relative" data-container="#pricing-switch">
                            <span class="pts-left fw-bold text-muted">Digital Content</span>
                            ...
                            <span class="pts-right fw-bold text-muted">Physical Sales</span>
                        </div>
                    </div>
                        ...
                        <div id="section-pricing" class="page-section p-0 m-0">
                            ...
                            <div id="pricing-switch" class="pricing row align-items-end g-0 col-mb-50 mb-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="pricing-box">
                                        <div class="pricing-title">
                                            <img class="mb-2 bg-transparent rounded-0" src="/demos/seo/images/icons/social.svg" alt="Pricing Icon" width="60">
                                            <h3>DCB</h3>
                                        </div>
                                        <div class="pricing-price">
                                            <div class="pts-switch-content-left"><span class="price-unit">%</span>12<span class="price-tenure"></span></div>
                                            <div class="pts-switch-content-right"><span class="price-unit">%</span>115<span class="price-tenure"></span></div>
                                        </div>

                                        <div class="pricing-action">
                                            <div class="pts-switch-content-left"><a href="/joinus?service=dcb" class="button button-rounded button-large button-light text-dark bg-white border w-100 nott m-0 ls0">Apply</a></div>
                                            <div class="pts-switch-content-right"><a href="/joinus?service=dcb" class="button button-rounded button-large button-light text-dark bg-white border w-100 nott m-0 ls0">Apply</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="pricing-box">
                                        <div class="pricing-title">
                                            <img class="mb-2 bg-transparent rounded-0" src="/demos/seo/images/icons/optimizing.svg" alt="Pricing Icon" width="60">
                                            <h3>Virtual Pos</h3>
                                        </div>
                                        <div class="pricing-price">
                                            <div class="pts-switch-content-left"><span class="price-unit">%</span>12<span class="price-tenure"></span></div>
                                        ...
                                        <div class="pricing-action">
                                            <div class="pts-switch-content-left"><a href="/joinus?service=pos" class="button button-rounded button-large button-light text-dark bg-white border w-100 nott m-0 ls0">Apply</a></div>
                                            <div class="pts-switch-content-right"><a href="/joinus?service=pos" class="button button-rounded button-large button-light text-dark bg-white border w-100 nott m-0 ls0">Apply</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="pricing-box">
                                        <div class="pricing-title">
                                            <img class="mb-2 bg-transparent rounded-0" src="/demos/seo/images/icons/transfer.svg" alt="Pricing Icon" width="60">
                                            <h3>Money Transfer</h3>
                                        </div>
                                        <div class="pricing-price">
                                            <div class="pts-switch-content-left"><span class="price-unit">%</span>17.5<span class="price-tenure"></span></div>
                                            <div class="pts-switch-content-right"><span class="price-unit">%</span>21<span class="price-tenure"></span></div>
                                        </div>

                                        <div class="pricing-action">
                                            <div class="pts-switch-content-left"><a href="/joinus?service=transfer" class="button button-rounded button-large button-light text-dark bg-white border w-100 nott m-0 ls0">Apply</a></div>
                                            <div class="pts-switch-content-right"><a href="/joinus?service=transfer" class="button button-rounded button-large button-light text-dark bg-white border w-100 nott m-0 ls0">Apply</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="pricing-box">
                                        <div class="pricing-title">
                                            <img class="mb-2 bg-transparent rounded-0" src="/demos/seo/images/icons/group.svg" alt="Pricing Icon" width="50">
                                            <h3>All Services</h3>
                                            <span>Most Popular</span>
                                        </div>
                                        <div class="pricing-price">
                                            <div class="pts-switch-content-left"><span class="price-unit">%</span>5<span class="price-tenure"></span></div>
                                            <div class="pts-switch-content-right"><span class="price-unit">%</span>48<span class="price-tenure"></span></div>
                                        </div>

                                        <div class="pricing-action">
                                            <div class="pts-switch-content-left"><a href="/joinus?service=all" class="button button-large button-rounded w-100 text-capitalize m-0 ls0">Apply</a></div>
                                            <div class="pts-switch-content-right"><a href="/joinus?service=all" class="button button-large button-rounded w-100 text-capitalize m-0 ls0">Apply</a></div>
                                        </div>
                                    </div>
