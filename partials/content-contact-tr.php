...
<section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header" style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #39384D), url('demos/seo/images/services/content_marketing-title.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
    ...
    <div class="container clearfix mt-4">
        <div class="badge rounded-pill border border-light text-light">İletişimde Kalalım</div>
        <h1>İLETİŞİM</h1>
        <ol class="breadcrumb">
        ...
        <div class="container mb-3">
            <div class="row justify-content-between">
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box flex-column text-center">
                        <div class="fbox-image text-center mb-3">
                            <img height="120" src="/demos/seo/images/icons/location.svg" alt="Feature Icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box flex-column text-center">
                        <div class="fbox-image text-center mb-3">
                            <img height="120" src="/demos/seo/images/icons/mailler.svg" alt="Feature Icon">
                        </div>
                        <div class="fbox-content">
                ...
                <!-- <div class="col-lg-3 col-md-6">
                    <div class="feature-box flex-column text-center">
                        ...
                        <div class="fbox-content">
                            <h3 class="nott ls0 mb-4">Başvuru:</h3>
                            <p class="text-smaller mb-3">Anında başvuru yapmak mümkün! Dilerseniz aşağıda bulunan alana tıklayarak anında başvuru yapabilrsiniz.</p>
